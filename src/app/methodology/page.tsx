  ...
  return (
    <div className="py-10 sm:py-16">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="rounded-3xl border border-slate-800 bg-[#071F36] p-8 sm:p-12 text-white shadow-lifted relative overflow-hidden text-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-80 w-80 rounded-full bg-[#0B4982]/30 blur-3xl -z-10" />

          <div className="mx-auto max-w-3xl space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#082949] border border-[#0B4982] px-4 py-1 text-2xs font-bold uppercase tracking-wider text-[#7ECB51]">
              <span>The Teaching Philosophy</span>
            </div>

            <h2 className="font-heading text-2.5xl sm:text-3.5xl md:text-4xl font-extrabold tracking-tight text-white leading-tight">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm font-mono text-slate-300">
